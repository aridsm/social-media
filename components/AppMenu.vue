...
<template>
  <div
    class="px-6 py-8 z-[9999] transition-all bg-base dark:bg-zinc-800 flex-col w-[20rem] xl:w-[15rem] 2xl:w-[20rem] h-full border-r border-r-zinc-200 dark:border-r-zinc-600"
  >
