        ...
        <div class="flex flex-col gap-8">
                    ...
                    <div class=" mt-8">
                        ...
                        <div class="flex items-center gap-8">
                            ...
                            <AppBtn class="ml-auto"
                                @click="modalBackgroundOpen = true, userBackground = user.backgroundPhoto">Change
                            </AppBtn>
                        </div>
                    </div>
                </div>
            ...
            <AppCard>
                ...
                <div class="grid grid-cols-2 gap-8">
                    ...
                    <AppSelectionInput v-model="userForm.generalInformations.gender" :list="genderList"
                        label="Gender" />
            ...
            <AppModal v-model:open="modalBackgroundOpen" content-class="w-[45vw]">
                ...
                <div class="mt-8 flex gap-4 justify-end">
                    ...
                    <AppBtn @click="userForm.backgroundPhoto = userBackground, modalBackgroundOpen = false">Confirm
                    </AppBtn>
                </div>
            </AppModal>
        </div>
